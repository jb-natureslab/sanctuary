...
<div class="sib-form" style="">
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div id="sib-container" class="sib-container--large sib-container--vertical" style="text-align:center; background-color:rgba(255,255,255,1); max-width:540px; border-radius:3px; border-width:1px; border-color:#C0CCD9; border-style:solid;">
      <form id="sib-form" method="POST" action="https://f473aaff.sibforms.com/serve/MUIEACOzb-kytZdRHxOKVWuGNoy0yRSCtkPD7fLlHGxGGcwAtoArYloM0xPU6ArkyI2D9VKA-gyZV13T8y5xAyxQjv7twyA-613NTBreKIy2oeJEfnOchfOvytacPS6H1EbwcZjkmaZMXzVUMxHSrdDhfjYC3wCcngQYM3rhWJgKBcd6Dml1gRf7sfwWfd8b2kYZkGC5HLJUtrfG" data-type="subscription">
              ...
              <div class="form__label-row ">
                ...
                <div class="entry__choice">
                  <label>
                    ...
                    <span class="checkbox checkbox_tick_positive"></span><span style="font-size:14px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#3C4858; background-color:transparent;"><p style="color:#ccc !important;">I agree to receive your newsletters and accept the data privacy statement.</p></span> </label>
                </div>
              </div>
              <label class="entry__error entry__error--primary" style="font-size:16px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#661d1d; background-color:#ffeded; border-radius:3px; border-color:#ff4949;">
              </label>
